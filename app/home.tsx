        ...
        <div className="">
          ...
          <div style={formStyle} className=" text-black">
            <div className=" flex flex-col  ">
              ...
              <footer className="text-black text-center z-1 ">
                <div className="text-xs ">
                  Project Z Group is committed to ensuring digital accessibility
                  for individuals with disabilities. We are continuously working
                  to improve the accessibility of our web experience for
                  everyone, and we welcome feedback and accommodation requests.
                  If you wish to report an issue or seek an accommodation,
                  please let us know.
                </div>
                <div className="p-5 text-xs ">
                  Project Z Inc. holds real estate brokerage licenses in
                  multiple states. Project Z (USA), Inc. holds real estate
                ...
                <div className="text-xs ">
                  ...
                  <div className="text-xs ">
                    TREC: Information about brokerage services, Consumer
                    protection notice
                  </div>
                ...
                <div className="text-xs ">
                  For listings in USA, the trademarks REALTOR®, REALTORS®, and
                  the REALTOR® logo are controlled by The USA Real Estate
